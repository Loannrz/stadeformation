  ...
  return (
    <>
      ...
      <nav className={`${styles.sidebar} ${open ? styles.sidebarOpen : ''}`}>
        ...
        <Link
          href="/admin/ia"
          className={`${styles.mapBtn} ${pathname === '/admin/ia' ? styles.mapBtnActive : ''}`}
          onClick={() => setOpen(false)}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path d="M12 2a7 7 0 00-4 12.74V17a2 2 0 002 2h4a2 2 0 002-2v-2.26A7 7 0 0012 2z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
